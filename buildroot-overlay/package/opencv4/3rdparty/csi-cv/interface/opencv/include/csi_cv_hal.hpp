...
int wrap_minMaxLoc(const unsigned char *src_data, size_t src_step, int src_depth, const unsigned char *mask_data, size_t mask_step,
                            int mask_depth, int width, int height, int cn, double *minVal, double *maxVal, int *minLoc, int *maxLoc);

int wrap_calcMinEigenVal(const unsigned char* src_data, size_t src_step, int src_depth, int src_cn,
                            const unsigned char* dst_data, size_t dst_step, int dst_depth, int dst_cn, int width, int height);

int wrap_calcHarris(const unsigned char* src_data, size_t src_step, int src_depth, int src_cn,
                        const unsigned char* dst_data, size_t dst_step, int dst_depth, int dst_cn, int width, int height, double k);
...
#undef cv_hal_minMaxLoc
#define cv_hal_minMaxLoc wrap_minMaxLoc

#undef cv_hal_calcMinEigenVal
#define cv_hal_calcMinEigenVal wrap_calcMinEigenVal

#undef cv_hal_calcHarris
#define cv_hal_calcHarris wrap_calcHarris
#endif
