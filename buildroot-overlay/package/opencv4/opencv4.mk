...
define OPENCV4_BUILD_DEB
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_highgui.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_video.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_videoio.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_imgcodecs.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_imgproc.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libopencv_core.so.4.5,$(@D)/deb/lib/riscv64-linux-gnu/)
	$(call COPYFILE ,$(TARGET_DIR)/usr/lib/libjpeg.so.9 ,$(@D)/deb/lib/riscv64-linux-gnu/)
