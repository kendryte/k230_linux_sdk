...
if(CONFIG_LV_BUILD_EXAMPLES)
    ...
    target_include_directories(lvgl_examples SYSTEM PUBLIC ${LVGL_ROOT_DIR}/examples ${LIBDRM_INCLUDE_DIRS})
...
if(CONFIG_LV_BUILD_DEMOS)
    ...
    target_include_directories(lvgl_demos SYSTEM PUBLIC ${LVGL_ROOT_DIR}/demos ${LIBDRM_INCLUDE_DIRS})
