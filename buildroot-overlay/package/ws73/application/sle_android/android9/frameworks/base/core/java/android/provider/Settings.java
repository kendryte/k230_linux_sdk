...
public final class Settings {
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String BLUETOOTH_INTEROPERABILITY_LIST = "bluetooth_interoperability_list";
         ...
         * @hide
         */
        public static final String NEARLINK_INTEROPERABILITY_LIST = "nearlink_interoperability_list";
        ...
        private static final Validator BLUETOOTH_ON_VALIDATOR = BOOLEAN_VALIDATOR;
        /**
         * Whether nearlink is enabled/disabled
         * 0=disabled. 1=enabled.
         */
        public static final String NEARLINK_ON = "nearlink_on";
        private static final Validator NEARLINK_ON_VALIDATOR = BOOLEAN_VALIDATOR;
                /**
         ...
         * @hide
         */
        public static final String SLE_SCAN_LOW_POWER_WINDOW_MS = "sle_scan_low_power_window_ms";

        /**
         * The length in milliseconds of a SLE scan window in a balanced scan mode.
         * @hide
         */
        public static final String SLE_SCAN_BALANCED_WINDOW_MS = "sle_scan_balanced_window_ms";
         ...
         * @hide
         */
        public static final String SLE_SCAN_BACKGROUND_MODE = "sle_scan_background_mode";
        ...
        public static final String getNearlinkHidHostPriorityKey(String address) {
            return NEARLINK_INPUT_DEVICE_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }
        ...
        */
        ...
        static {
            ...
            VALIDATORS.put(NEARLINK_ON, NEARLINK_ON_VALIDATOR);
