    ...
    public static Pair<Drawable, String> getNlClassDrawableWithDescription(Context context, CachedNearlinkDevice cachedDevice, float iconScale) {
        ...
        switch (nlClass) {
            case NearlinkAppearance.GENERAL_PHONE:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_phone, level, iconScale), context.getString(R.string.nearlink_talkback_phone));

            case NearlinkAppearance.HEAD_HEADSET:
            case NearlinkAppearance.NECK_HEADSET:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_headphones_a2dp, level, iconScale),
                        context.getString(R.string.nearlink_talkback_headphone));

            case NearlinkAppearance.HEAD_EARPHONE:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_headset_hfp, level, iconScale),
                        context.getString(R.string.nearlink_talkback_headset));

            case NearlinkAppearance.IN_EAR_HEADSET:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_hearing_aid, level, iconScale),
                        context.getString(R.string.nearlink_talkback_headphone));

            case NearlinkAppearance.GENERAL_COMPUTER:
            case NearlinkAppearance.TOUCH_PAD:
            case NearlinkAppearance.TABLET_PC:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_laptop, level, iconScale),
                        context.getString(R.string.nearlink_talkback_computer));

            case NearlinkAppearance.MOUSE:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_pointing_hid, level, iconScale),
                        context.getString(R.string.nearlink_talkback_input_peripheral));

            case NearlinkAppearance.GENERAL_HID:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_bt_misc_hid, level, iconScale),
                        context.getString(R.string.nearlink_talkback_input_peripheral));

            case NearlinkAppearance.KEYBOARD:
                return new Pair<>(getNearlinkDrawable(context, com.android.internal.R.drawable.ic_lockscreen_ime, level, iconScale),
                        context.getString(R.string.nearlink_talkback_input_peripheral));
