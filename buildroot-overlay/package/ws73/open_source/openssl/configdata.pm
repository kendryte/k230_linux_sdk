...
our %config = (
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "/opt/toolchain/Xuantie-900-gcc-linux-6.6.0-glibc-x86_64-V2.10.1/bin/riscv64-unknown-linux-gnu-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  openssldir => "",
  options => "enable-shared --prefix=/home/jyh/ws73_sdk_linux_ws73_1.10.110/output/build/open_source/openssl --cross-compile-prefix=/opt/toolchain/Xuantie-900-gcc-linux-6.6.0-glibc-x86_64-V2.10.1/bin/riscv64-unknown-linux-gnu- no-afalgeng no-asan no-asm no-async no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.38.2",
  perlargv => [ "linux-x86", "no-asm", "shared", "no-async", "--prefix=/home/jyh/ws73_sdk_linux_ws73_1.10.110/output/build/open_source/openssl", "--cross-compile-prefix=/opt/toolchain/Xuantie-900-gcc-linux-6.6.0-glibc-x86_64-V2.10.1/bin/riscv64-unknown-linux-gnu-" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/jyh/ws73_sdk_linux_ws73_1.10.110/output/build/open_source/openssl",
  processor => "",
