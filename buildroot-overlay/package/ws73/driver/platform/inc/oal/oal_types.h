...
#define OAL_EIO             5   /* IO 错误 */
#define OAL_ENOMEM          12  /* 内存越界 */
#define OAL_EFAUL           14  /* 错误地址 */
#define OAL_EBUSY           16  /* 设备忙碌 */
#define OAL_ENODEV          19  /* 无此设备 */
#define OAL_EINVAL          22  /* 无效参数 */
#define OAL_ETIMEDOUT       110 /* 连接超时 */
...
{
    OAL_SUCC                                  = 0,                              /* 成功，没有异常 */
    OAL_CONTINUE                              = 2,                              /* 定义拆分函数是否需要执行后续函数 */
    ...
    **************************************************************************/
    ...
    OAL_ERR_CODE_MAC_DEVICE_NULL              = (OAL_ERR_CODE_SYS_BASE + 7),    /* hmac_device_struz找不到 */
...
/**************************** wapi 特性 ***********************************/
    ...
    OAL_ERR_CODE_OAL_MEM_EXCEED_TOTAL_CNT    = (OAL_ERR_CODE_OAL_MEM_BASE + 9),   /* 可用内存块数目超过整个子内存池总数 */
    ...
    OAL_ERR_CODE_NCI_PACKET_INVALID                     = (OAL_ERR_CODE_NCI_BASE + 9),      /* 接收到的NCI Packet无效 */
