...
ifneq ($(findstring c908v,$(BR2_TARGET_OPTIMIZATION)),)
LLAMA_CPP_CONF_OPTS += -DGGML_RVV=ON  -DGGML_RVV_VLEN=128  -DGGML_NATIVE=OFF  -DLLAMA_BUILD_TOOLS=ON

define LLAMA_CPP_LINUX_CONFIG_FIXUPS
	$(call KCONFIG_SET_OPT,CONFIG_CMA_SIZE_PERCENTAGE, 2)
endef
