...
UBOOT_OVERLAY_DIRS=$(TOPDIR)/../../buildroot-overlay/boot/uboot/u-boot-2022.10-overlay
# UBOOT_OVERLAY_FILES=$(shell find  $(UBOOT_OVERLAY_DIRS)/ -type f)


$(UBOOT_DIR)/.overlay_sync: $(UBOOT_DIR)/.stamp_patched
$(UBOOT_DIR)/.stamp_configured:  $(UBOOT_DIR)/.overlay_sync
$(UBOOT_DIR)/.stamp_dotconfig:  $(UBOOT_DIR)/.overlay_sync
$(UBOOT_DIR)/.overlay_sync:$(TOPDIR)/../.uboot_overlay_sync  $(UBOOT_DIR)/.stamp_patched
	rsync -a $(UBOOT_OVERLAY_DIRS)/ $(UBOOT_DIR)/	
	touch $@
