...
add_firmware_head: u-boot.bin spl/u-boot-spl.bin u-boot.img 
	#给一级boot增加bootrom头
	PATH=$${PATH#*host/bin:};echo $${PATH};cp spl/u-boot-spl.bin  t.bin ; python3 $(srctree)/tools/firmware_gen.py  -i t.bin -o u-boot-spl-k230.bin -n
	...
	PATH=$${PATH#*host/bin:};echo $${PATH}; cp u-boot.img t.bin;python3 $(srctree)/tools/firmware_gen.py  -i  t.bin -o fn_u-boot.img -n
