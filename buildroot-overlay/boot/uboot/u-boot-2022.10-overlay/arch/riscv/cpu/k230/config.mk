...
add_firmware_head: u-boot.bin spl/u-boot-spl.bin u-boot.img
	#给一级boot增加bootrom头
	cp spl/u-boot-spl.bin  t.bin ; python3 $(srctree)/tools/firmware_gen_no_securiy.py  -i t.bin -o u-boot-spl-k230.bin -n
	...
	cp u-boot.img t.bin;python3 $(srctree)/tools/firmware_gen_no_securiy.py  -i  t.bin -o fn_u-boot.img -n


	# cp spl/u-boot-spl.bin  t.bin ; python3 $(srctree)/tools/firmware_gen_no_securiy.py  -i t.bin -o u-boot-spl-k230_aes.bin -a
	# $(srctree)/tools/endian-swap.py   u-boot-spl-k230.bin  u-boot-spl-k230_aes-swap.bin
	# cp spl/u-boot-spl.bin  t.bin ; python3 $(srctree)/tools/firmware_gen_no_securiy.py  -i t.bin -o u-boot-spl-k230_sm.bin -s
