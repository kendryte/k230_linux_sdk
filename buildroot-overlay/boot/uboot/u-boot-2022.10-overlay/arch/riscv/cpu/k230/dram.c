...
{
int rdata;
   writel(0x10001,(void *)pll_ctl);
   rdata=readl((void*)pll_stat);
...
static uint32_t cfg_pll(int fb_div,int ref_div,int out_div,int pllx_cfg0,int pllx_cfg1,int pllx_ctl,int pllx_stat)
{
  ...
  writel(( (fb_div/4) | 0x20000),(void*)pllx_cfg1 ); //for minimum long term jitter
  writel(( (fb_div & 0x1fff) | ( (ref_div & 0x3f) << 16 ) | ( (out_div & 0xf) << 24) ),(void*)pllx_cfg0 );
